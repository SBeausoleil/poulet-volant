...
class ListCVComponent extends Component {
    ...
    deleteDownload(id) {
        ...
        this.notificationHandler('Vous avez supprimer un curriculum vitae.');
    }
    ...
    render() {
        return (
            <div>
                <div>
                    <h2 className="text-center">Liste des Curriculum Vitae</h2>
                                ...
                                this.state.files.map(
                                    file =>
                                        <tr key={file.id}>
                                            <td>{file.fileName}</td>
                                            <td>{file.fileType}</td>
                                            <td>{file.user.lastName},{file.user.firstName}</td>
                                            <td>
